                ...
                <div className="hidden lg:flex items-center gap-2 flex-wrap">
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-3 py-2 text-sm font-medium text-gray-700 hover:border-gray-300"
                        >
                            <Calendar className="w-3.5 h-3.5 text-gray-400" />
                            {MONTH_NAMES_VI[month - 1]}/{year}
                            <ChevronDown className={`w-3.5 h-3.5 text-gray-400 transition-transform ${monthPickerOpen ? "rotate-180" : ""}`} />
                        </button>
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 bg-white border border-gray-200 rounded-xl px-3 py-2 text-sm font-medium text-gray-600 hover:border-gray-300"
                    >
                    ...
                    <button
                        ...
                        disabled={exporting}
                        className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-900 text-white rounded-xl px-4 py-2 text-sm font-semibold disabled:opacity-50"
                    >
                    ...
                    <div className="flex items-center justify-between gap-3 px-4 py-3.5 border-b border-gray-100">
                        ...
                        <div className="flex lg:hidden items-center gap-2 flex-shrink-0">
                            <div className="relative">
                                <button
                                    onClick={() => setMonthPickerOpen((v) => !v)}
                                    className="flex items-center gap-1 bg-gray-50 border border-gray-200 rounded-lg px-2.5 py-1.5 text-[11px] font-medium text-gray-600 whitespace-nowrap"
                                >
                                ...
                                {monthPickerOpen && (
                                    <>
                                        <div className="fixed inset-0 z-10" onClick={() => setMonthPickerOpen(false)} />
                                        <div className="absolute right-0 top-9 z-20 w-56 bg-white border border-gray-100 rounded-xl shadow-lg p-3">
                                            <div className="flex items-center justify-between mb-2">
                                                <button onClick={() => changeMonth(-1)} className="p-1.5 rounded-lg text-gray-400 hover:bg-gray-100">
                                                    <ChevronLeft className="w-4 h-4" />
                                                </button>
                            ...
                            <button
                                onClick={openFilterSheet}
                                className="relative flex items-center gap-1 bg-gray-50 border border-gray-200 rounded-lg px-2.5 py-1.5 text-[11px] font-medium text-gray-600 whitespace-nowrap"
                            >
