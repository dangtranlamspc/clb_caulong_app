...
import { ArrowLeft, Loader2, CalendarDays, ChevronRight, Users } from "lucide-react";
        ...
        <div className={`min-h-screen bg-[#F4F6FA] overflow-y-auto ${HIDE_SCROLLBAR_CLASS}`}>
                                        ...
                                        {matches.map((m: any) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        onClick={() => openViewMatch(m)}
                                                        className="absolute bottom-2.5 left-3 inline-flex items-center gap-1 text-[11px] font-bold text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 rounded-full px-3 py-1.5 transition-colors"
                                                    >
            ...
            {viewMatch && (
                <MatchLineupsViewModal
                    ...
                    team1={viewMatch.team1}
                    team2={viewMatch.team2}
