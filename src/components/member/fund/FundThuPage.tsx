        ...
        <div className="min-h-screen bg-gray-50">
            ...
            >
                <div className="max-w-md mx-auto flex items-center justify-between px-4 py-3.5">
                    ...
                    <h1 className="text-base font-bold text-gray-900">Nguồn thu</h1>
            ...
            <div className="max-w-md mx-auto px-4 py-4 space-y-4">
                ...
                <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4 text-center">
                    <p className="text-xs text-emerald-600/70 mb-1">Tổng thu (trang này)</p>
                    <p className="text-xl font-black text-emerald-600">+{fmt(totalThu)}</p>
                </div>
                ...
                <div className="flex items-center gap-2 overflow-x-auto pb-1 -mx-4 px-4">
                    {[{ val: "", label: "Tất cả" }, ...THU_CATEGORIES.map((c) => ({ val: c, label: CATEGORY_LABELS[c] }))].map((o) => (
                        <button
                            ...
                            className={`flex-shrink-0 px-3.5 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-colors ${category === o.val ? "bg-emerald-600 text-white" : "bg-white border border-gray-200 text-gray-500"}`}
                        >
                            {o.label}
                        </button>
                    ))}
