    ...
    return (
        <div ref={ref} className="relative">
            <button
                type="button"
                onClick={toggle}
                className={`w-full flex items-center justify-between gap-2 bg-white border rounded-xl px-4 py-3 text-sm font-medium text-gray-900 transition-colors ${open ? "border-blue-400 ring-2 ring-blue-100" : "border-gray-200 hover:border-gray-300"
                    }`}
            >
            ...
            {mounted && (
                <div
                    ...
                    style={{
                        ...
                        opacity: open ? 1 : 0,
                        transition: "transform .16s cubic-bezier(.34,1.56,.64,1), opacity .12s ease",
                    }}
                >
                    <div className="max-h-72 overflow-y-auto py-1">
                        <button
                            ...
                            className={`w-full flex items-center justify-between px-4 py-2.5 text-sm text-left transition-colors ${!value ? "bg-blue-50 text-blue-700 font-medium" : "text-gray-700 hover:bg-gray-50"
                                }`}
                        >
                            {allLabel}
