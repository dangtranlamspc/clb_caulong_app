    ...
    const load = useCallback(
        async (opts?: { silent?: boolean }) => {
            ...
            try {
                ...
                // Chỉ tự động chọn lượt lần đầu tải trang, các lần cập nhật realtime
                // sau đó giữ nguyên lượt người dùng đang xem.
        ...
        <div className="min-h-screen bg-[#F4F6FA]">
            ...
            <div className="max-w-lg lg:max-w-3xl mx-auto px-4 pt-4 pb-8">
                {loading ? (
                    ...
                    <>
                        <div className="flex items-center gap-2 overflow-x-auto pb-1 mb-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                            {rounds.map((r) => {
